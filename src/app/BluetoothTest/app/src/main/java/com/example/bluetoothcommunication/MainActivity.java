...
public class MainActivity extends AppCompatActivity {
    ...
    // Bluetooth Request Activity Code
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(this, "블루투스를 지원하지 않는 단말기입니다.", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
        ...
        // If Bluetooth is off, request to user
    ...
    // Bluetooth State Change BroadcastReceiver
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action) {
                ...
                case BluetoothDevice.ACTION_FOUND:
                    ...
                    break;
                // Finish Searching Bluetooth Device
    ...
    // Click Button Searching Bluetooth Device
        ...
        public void handleMessage(Message msg_type) {
            ...
            switch (msg_type.what){
                case MESSAGE_READ:
                    ...
                    textView.setText(string_recieved);
                    //Log.d("line 237", "MESSAGE_READ");/////
                    //////////
                ...
                case MESSAGE_WRITE:
                    ...
                    //Log.d("line 247", "MESSAGE_WRITE");
                    break;

                case CONNECTED:
                    Toast.makeText(getApplicationContext(),"Connected",Toast.LENGTH_SHORT).show();
                    //Log.d("line 252", "CONNECTED");
                    break;

                case CONNECTING:
                    Toast.makeText(getApplicationContext(),"Connecting...",Toast.LENGTH_SHORT).show();
                    //Log.d("line 257", "CONNECTING");
                    break;

                case NO_SOCKET_FOUND:
                    Toast.makeText(getApplicationContext(),"No socket found",Toast.LENGTH_SHORT).show();
                    //Log.d("line 262", "NO_SOCKET_FOUND");
                    break;
            }
        }
    };
...
//        <uses-permission android:name="android.permission.ACCESS_FINE_LOCATION"/>
        ...
        if (!bluetoothAdapter.isEnabled()) {
            ...
            if (set_pairedDevices.size() > 0) {
                ...
                for (BluetoothDevice device : set_pairedDevices) {
                    ...
                    //Log.d("line 337", "adapter_paired_devices.add");
                }
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                //Log.d("line 405", "CONNECTING");

                mmSocket.connect();
                //Log.d("line 408", "CONNECTING");
            ...
            //Log.d("line 419", bluetooth_message);
            //////////
        }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            mmInStream = tmpIn;
            mmOutStream = tmpOut;
            //Log.d("line 451", "ConnectedThread");
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    //Log.d("line 465", "ConnectThread.run");
                } catch (IOException e) {
                    break;
                }
            }
        ...
        public void write(byte[] bytes) {
            try {
                ...
                //Log.d("ConnectedThread.write", bytes.toString());
            } catch (IOException e) { }
        }
